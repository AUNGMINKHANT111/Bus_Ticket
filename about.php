      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-5">
          	<p class="breadcrumbs"><span class="mr-2"><a href="booksearch.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>About us <i class="ion-ios-arrow-forward"></i></span></p>
...
<li>All express buses from BHW Express are Scania Brand from Europe.</li>
<li>We provide fully air conditioning system in all of the BHW Express Buses.</li>
<li>The seats are wide and very convenient for the passengers. (We never put extra seats in the middle passage.)</li>
<li>Very well-disciplined two drives and two helpers are allocated in every Shwe Mandalar Buses which is the proof of our safety first priority for the passengers.</li>
<li>We are providing good services and we offer free tooth-paste, tooth brush, drinking water and towel to all of the passengers</li>
<li>
 BHW Express drivers have driven large vehicles for more than 10 years and have passed the driving training given by HIGER Bus Company.They drive very carefully as if there are their families on buses.They have to go for medical check-ups every six months and only those who pass them are allowed to drive. (passed medical check- up A,B,C test )
</li>
    ...
    <section class="ftco-section services-section img" style="background-image: url(images/abd.jpg);">
    	<div class="overlay"></div>
    	<div class="container">
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb">
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/ae.jpg);">
					</div>
	          ...
	          <div class="heading-section mb-5 pl-md-5">
	            ...
	            <h2 class="mb-4">About BHW Express</h2>

	            <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBHW Express is one of the biggest and most popular local transportation companies. They are well known among locals and tourists. The company provides great service and competitive prices and is known to be reliable, safe, and comfortable.</p>
	          </div>
					</div>
				</div>
			</div>
