<br>
<section class="ftco-section services-section img" style="background-image: url(images/my.jpg);">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">203 Fake St. Mountain View, San Francisco, Yangon, Myanmar</span></li>
	                <li><a ><span class="icon icon-phone"></span><span class="text">+95 423136218</span></a></li>
	                <li><a ><span class="icon icon-envelope"></span><span class="text">bhwbuscompany.com</span></a></li>
	              </ul>
	            </div>
            </div>
