...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">BHW<span>Bus Company</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="car.php" class="nav-link">Our Car</a></li>
      ...
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="col-md-10 text-center d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20 img" style="background-image: url('images/blog.jpg');">
              </a>
              <div class="text pt-4">
              	<div class="meta mb-3">
